...
//contain struct for each of the service endpoints
type grpcServer struct {
	hash     grpctransport.Handler
	validate grpctransport.Handler
}
//these methods serve requests by 1st decoding them,calling the appropiate endpoint function ,getting the response and
// encoding it and sending it back to client who made the request
...
//translateour hashrequest type into protocol buffer type that can be used to communicate with client
